...
<div class="card shadow-sm border-0">
    ...
    <div class="card-body p-0">
        <ul class="nav nav-tabs nav-fill border-0">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo @$_GET['tab']=='loans'?'active':''?>" href="?tab=loans">
                    <i class=""></i>Výpůjčky emoji
                </a>
            </li>
        </ul>
        ...
        <div class="tab-content p-4">
            ...
            <div class="tab-pane fade show <?php echo @$_GET['tab']=='loans'?'active':''?>" id="loans">
                <p>TODO:  nova vypujcka </p>
