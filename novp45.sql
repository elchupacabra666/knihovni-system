...
-- Vytvořeno: Sob 17. kvě 2025, 14:01
...
INSERT INTO `books` (`book_id`, `title`, `description`, `category_id`, `image`, `author`, `year`, `country_id`) VALUES
(1, 'The Accidental Billionaires', 'The story behind the creation of Facebook.', 1, 'covers/1.jpg', 'Ben Mezrich', 2009, 1),
(2, 'Pride and Prejudice', 'A classic novel about love and society in 19th-century England.', 2, 'covers/1.jpg', 'Jane Austen', 1813, 1),
(3, 'Dune', 'A groundbreaking science fiction epic set on a desert planet.', 3, 'covers/1.jpg', 'Frank Herbert', 1965, 1),
(4, 'The Girl with the Dragon Tattoo', 'A gripping thriller involving a journalist and a hacker.', 4, 'covers/1.jpg', 'Stieg Larsson', 2005, 1),
(5, 'Bridget Jones\'s Diary', 'A humorous look at the life of a single woman in London.', 1, 'covers/1.jpg', 'Helen Fielding', 1996, 1),
(6, 'The Notebook', 'A poignant love story spanning decades.', 2, 'covers/1.jpg', 'Nicholas Sparks', 1996, 1),
(7, 'Foundation', 'A seminal science fiction series about the fall and rise of a galactic empire.', 3, 'covers/1.jpg', 'Isaac Asimov', 1951, 1),
(8, 'Gone Girl', 'A psychological thriller with unexpected twists.', 4, 'covers/1.jpg', 'Gillian Flynn', 2012, 1);
...
(12, 'Patrik', 'test@test.test', '$2y$10$ys.NW9lTDuovQq51lEl/N.8hqG3kGrrHTVsfr1yrNtz9J3oUbOn4e', 'member');
...
ALTER TABLE `books`
  ...
  ADD CONSTRAINT `books_ibfk_2` FOREIGN KEY (`country_id`) REFERENCES `countries` (`country_id`);
