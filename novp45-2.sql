...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Sob 07. čen 2025, 11:26
...
(1, 'The Accidental Billionaires', 'The story behind the creation of Facebook.', 1, 'covers/1.jpg', 'Ben Mezrich', 2009, 1, 1),
(2, 'Pride and Prejudice', 'A classic novel about love and society in 19th-century England.', 2, 'covers/1.jpg', 'Jane Austen', 1813, 1, 1),
(3, 'Dune', 'Kniha z duny', 3, 'covers/1.jpg', 'Frank Herbert', 1965, 1, 1),
...
(5, 'Bridget Jones\'s Diary', 'A humorous look at the life of a single woman in London.', 1, 'covers/1.jpg', 'Helen Fielding', 1996, 1, 1),
...
CREATE TABLE `loans` (
  ...
  `book_id` int(11) NOT NULL,
  `last_edit_starts_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `last_edit_starts_by_user` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_czech_ci;
